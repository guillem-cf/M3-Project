...
def train():
    ...
    mc = ModelCheckpoint(
        "./checkpoint/best_" + wandb.config.experiment_name + "_model_checkpoint" + ".h5",
        monitor="val_loss",
        mode="min",
        save_best_only=True,
    )
...
# def main():
    ...
    #     data_augmentation_HF = args.horizontal_flip,
    #     data_augmentation_VF = args.vertical_flip,
    #     data_augmentation_R = args.rotation,
    #     data_augmentation_Z = args.zoom,
    #     data_augmentation_W = args.width_shift,
    #     data_augmentation_H = args.height_shift,
    #     data_augmentation_S = args.shear
    #     # model = args.MODEL,
    # )
